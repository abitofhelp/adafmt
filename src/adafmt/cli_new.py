...
def format_command(
    ...
    format_rules_path: Annotated[Optional[Path], typer.Option("--format-rules-path", help="Path to formatting rules JSON file (default: ./adafmt_format_rules.json)")] = None,
